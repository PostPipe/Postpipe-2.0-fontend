                    ...
                    <div className="flex items-center justify-between gap-4 flex-wrap mb-6">
                        <TabsList className="bg-muted dark:bg-white/[0.06] rounded-lg h-10 p-1 gap-1">
                            ...
                            <TabsTrigger value="rbac" className="rounded-lg text-xs font-semibold data-[state=active]:bg-background dark:data-[state=active]:bg-white/10 data-[state=active]:text-neutral-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm text-muted-foreground px-4 h-8 transition-all">
                                <Settings2 className="mr-2 h-3.5 w-3.5" /> Role Based Auth Preset
                            </TabsTrigger>
                        </TabsList>
                    </div>
        ...
        console.error("Authentication Error:", error);
                    ...
                    <TabsContent value="rbac" className="mt-0">
                        <div className="rounded-lg border border-neutral-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.03] p-6 backdrop-blur-xl animate-in zoom-in-95 duration-200">
                            <div className="flex items-center justify-between mb-6 border-b border-neutral-200 dark:border-white/[0.08] pb-4">
                                <div>
                                    <h2 className="text-base font-bold text-neutral-800 dark:text-white/80">Role Based Access Control</h2>
                                    <p className="text-xs text-neutral-500 dark:text-white/30 mt-1">Configure your RBAC presets and permission rules here.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-center gap-4 py-20 text-center">
                                ...
                                <div>
                                    <p className="text-base font-semibold text-neutral-600 dark:text-white/50">RBAC Settings</p>
                                    <p className="mt-1 text-sm text-neutral-400 dark:text-white/30">Connect your RBAC component here.</p>
                                </div>
                            </div>
                        </div>
                    </TabsContent>
