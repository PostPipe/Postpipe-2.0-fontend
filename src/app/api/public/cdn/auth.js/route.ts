    ...
    class PostpipeAuthClient {
        constructor() {
            this.config = {
                ...
                apiUrl: 'http://localhost:3002/api/auth' // Fallback to local during dev, should be dynamic in prod based on connector mapping
            };
            this.listeners = {
                success: [],
                error: []
        ...
        render() {
            ...
            if (hasGoogle) {
                html += \`<button onclick="PostpipeAuth.loginWithOAuth('google')" class="pp-btn pp-btn-oauth">
            ...
            if (hasGithub) {
                html += \`<button onclick="PostpipeAuth.loginWithOAuth('github')" class="pp-btn pp-btn-oauth">
            ...
            if (hasEmail) {
                ...
                html += \`
                    ...
                    <button id="pp-submit-btn" class="pp-btn pp-btn-primary" onclick="PostpipeAuth._handleFormSubmit()">
